...
// Next.js 16 : le fichier s'appelle proxy.ts (et non plus middleware.ts)
// La fonction doit être exportée comme export default.
export default async function proxy(req: NextRequest) {
  ...
  if (pathname.startsWith(ADMIN_PREFIX)) {
    ...
    // Toutes les autres pages admin : vérification du token JWT
